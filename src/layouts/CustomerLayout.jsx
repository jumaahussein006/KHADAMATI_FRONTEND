...
const CustomerLayout = ({ children }) => {
  ...
  const menuItems = [
    { path: '/customer/dashboard', icon: FiHome, label: t('common.dashboard') },
    { path: '/customer/requests', icon: FiFileText, label: t('dashboard.customer.myRequests') },
    { path: '/customer/profile', icon: FiUser, label: t('dashboard.customer.myProfile') },
    { path: '/customer/notifications', icon: FiBell, label: t('common.notifications') },
    { path: '/customer/submit-report', icon: FiAlertCircle, label: i18n.language === 'ar' ? 'إرسال تقرير' : 'Submit Report' },
    { path: '/customer/my-reports', icon: FiFileText, label: i18n.language === 'ar' ? 'تقاريري' : 'My Reports' },
  ];
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-4 border-t border-gray-200 dark:border-gray-700">
              <div className="mb-4 px-4 py-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">{t('dashboard.customer.customer')}</p>
              </div>
              <button

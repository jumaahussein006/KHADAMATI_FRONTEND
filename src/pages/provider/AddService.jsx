    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-100 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="text-sm font-bold text-gray-600 dark:text-gray-300">{t('service.category')}</label>
            <select
              className={inputClass}
            ...
            >
              <option value="">{loadingCategories ? t('common.loading') : t('common.select')}</option>
              {categories.map((cat) => {
